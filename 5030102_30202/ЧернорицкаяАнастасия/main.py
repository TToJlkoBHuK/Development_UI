...
def main() -> None:
    print("Тестирование робота-техника...")

    # Создаем лабиринт 3x3
    лабиринт = ЛабиринтРоботТехник()
    лабиринт.ИнициализироватьЛабиринт(ТипЯчеекРемесло.Пол, 3, 3)

    # Размещаем робота в центре
    лабиринт.ячейки[1][1].ячейка_робота = True
    лабиринт.ячейки[1][1].тип_ячейки = ТипЯчеекРемесло.Оборуд

    # Создаем робота
    робот = РоботТехник(лабиринт)

    print(f"Текущая ячейка: {робот.текущая_ячейка}")
    print(f"Тип текущей ячейки: {робот.текущая_ячейка.тип_ячейки if робот.текущая_ячейка else None}")

    робот.Оборуд()

    print(f"Тип текущей ячейки после Оборуд: {робот.текущая_ячейка.тип_ячейки if робот.текущая_ячейка else None}")
